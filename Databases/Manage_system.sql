...
INSERT INTO `course_examine_child_methods` VALUES (11,1,'平时考核成绩',23,100,'[\"课程目标1\"]','[\"指标点1\",\"指标点2\"]'),(13,1,'实验考核成绩',12,100,'[\"课程目标1\"]','[\"指标点1\"]'),(16,20,'考勤',34,100,'[\"课程目标1\"]','[]'),(17,20,'课题提问',29,100,'[\"课程目标1\"]','[]'),(21,20,'作业',47,100,'[\"课程目标1\",\"课程目标2\",\"课程目标3\"]','[\"指标点1.1\",\"指标点1.2\"]'),(25,20,'期中测试',27,100,'[\"课程目标1\"]','[\"指标点1.1\"]'),(26,24,'实验项目完成分',24,100,'[\"课程目标1\",\"课程目标2\"]','[]'),(27,24,'大报告',23,100,'[\"课程目标1\",\"课程目标2\"]','[]'),(28,24,'试卷',29,100,'[\"课程目标2\"]','[\"指标点1.1\",\"指标点1.2\"]'),(29,1,'考勤',18,100,'[\"课程目标1\"]','[\"指标点1.1\",\"指标点1.2\"]'),(31,3,'考勤',17,100,'[\"课程目标1\"]','[\"指标点1.1\",\"指标点1.2\",\"指标点5.2\"]'),(32,3,'课题提问',11,100,'[\"课程目标1\"]','[\"指标点1.2\"]'),(33,25,'考勤',13,100,'[]','[\"指标点1.1\",\"指标点5.2\",\"指标点2.1\"]'),(34,25,'课题提问',11,100,'[]','[\"指标点1.1\"]'),(35,25,'考勤',50,100,'[]','[\"指标点1.1\",\"指标点1.2\",\"指标点5.2\"]'),(36,26,'试卷',100,100,'[\"课程目标1\",\"课程目标2\",\"课程目标3\"]','[\"指标点1.1\",\"指标点1.2\"]'),(37,5,'考勤',33,100,'[]','[\"指标点1.1\",\"指标点1.2\",\"指标点5.2\"]');
...
INSERT INTO `course_final_exam_paper` VALUES (10,36,'选择题',20),(11,36,'填空题',30),(12,36,'简答题',50),(16,26,'tets',12);
...
INSERT INTO `course_final_exam_paper_detail` VALUES (4,11,'1',2,'1','1'),(5,11,'1',2,'1','1'),(6,11,'1',2,'1','1'),(8,12,'1',2,'1','1'),(9,12,'2',2,'1','1'),(10,12,'3',2,'1','1'),(11,12,'3',2,'1','1'),(12,12,'3',2,'1','1'),(13,12,'3',2,'1','1'),(14,12,'3',2,'1','1'),(15,12,'3',2,'1','1'),(16,12,'3',2,'1','1'),(17,12,'3',2,'1','1'),(18,12,'3',2,'1','1'),(19,12,'3',2,'1','1'),(20,12,'3',2,'1','1'),(21,12,'3',2,'1','1'),(22,12,'3',2,'1','1'),(23,12,'3',2,'1','1'),(24,12,'3',2,'1','1'),(25,12,'3',2,'1','1'),(26,12,'3',2,'1','1'),(27,12,'3',2,'1','1'),(28,12,'3',2,'1','1'),(29,12,'3',2,'1','1'),(30,12,'3',2,'1','1'),(31,10,'3',2,'[\"指标点1.1\",\"指标点1.2\",\"指标点5.2\"]','[\"课程目标1\",\"课程目标2\",\"课程目标3\"]'),(32,10,'1',10,'[\"指标点1.2\",\"指标点2.1\"]','[\"课程目标1\",\"课程目标2\"]'),(33,10,'2',2,'[\"指标点1.1\",\"指标点1.2\",\"指标点5.2\",\"指标点2.1\"]','[\"课程目标1\",\"课程目标2\",\"课程目标3\"]');
...
-- Dump completed on 2023-03-30 18:07:43
